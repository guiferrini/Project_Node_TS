...
container.registerSingleton<IUserTokensRepository>( // a Tipagem garante q 2° parametro esteja no formato correto
  'UserTokensRepository', // id/nome (eu escolho)
  UserTokensRepository, // repositorio q vai usar na injeção
);
